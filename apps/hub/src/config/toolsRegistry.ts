...
export const TOOLS_REGISTRY: ToolEntry[] = [
  ...
  // Career Prep Room
  {
    ...
    description: 'Job hunt overview, salary calculator, cold email builder, and application tracker.',
    path: '/tools/career',
    workspace: 'career',
  ...
  },
  {
    ...
    path: '/tools/career/salary-calculator',
    workspace: 'career',
  ...
  },
  {
    ...
    path: '/tools/career/salary-benchmarking',
    workspace: 'career',
  ...
  },
  {
    ...
    description: 'Create QR codes for URLs, Wi-Fi, and text instantly.',
  ...
  },
  {
    ...
    description: 'Generate strong random passwords offline.',
  ...
  },
  {
    ...
    description: 'Live MD5, SHA-1, and SHA-256 digests from any text — Web Crypto API, zero dependencies.',
  ...
  },
  {
    ...
    description: 'Convert between CSV, JSON, and XML in the browser.',
    path: '/tools/quick/format-converter',
    workspace: 'quick',
    keywords: ['csv', 'json', 'xml', 'format', 'convert'],
  },
  {
    id: 'color-palette',
    name: 'Color Palette Generator',
    description: 'Build and export color palettes for design projects.',
    path: '/tools/quick/color-palette',
    workspace: 'quick',
  ...
  },
  {
    id: 'decision-wheel',
    name: 'Decision Wheel',
    description: 'Spin a wheel to make quick random choices.',
    path: '/tools/quick/decision-wheel',
    workspace: 'quick',
    keywords: ['wheel', 'random', 'decide', 'spin'],
  },
  {
    id: 'seo-meta-tags',
    name: 'SEO Meta Tag Generator',
    description: 'Preview and copy HTML meta tags for web pages.',
    path: '/tools/quick/seo-meta-tags',
    workspace: 'quick',
    keywords: ['seo', 'meta tags', 'og', 'twitter card'],
  },
  {
    id: 'recipe-scaler',
    name: 'Recipe Scaler',
